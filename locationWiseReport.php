...
<head>
	...
	<title>Location Wise Report</title>
	...
	<section class="mainpart" id='mainpart'>
		<div class="container-fluid">
			...
			if (isset($_POST['submit'])) {
                ...
                echo "<div class='container-fluid text-center mb-4'>
                    <div class='row'>
                        ...
                        <div class='col-lg-8 col-md-8 col-12'>
                            ...
                            <label style='font-weight:normal;font-size: 1.4rem; color:#000;'>(Location Wise)</label><br>
                ...
                $curs = oci_new_cursor($conn);
                $stid = oci_parse($conn, "begin DPG_MINISTRY_REPORT.DPD_LOCATION_WISE(:cur_data,:P_BILL_CYCLE_CODE,:P_ZONE_CODE,:P_CIRCLE_CODE, :P_COMP_CNTR_CODE, :P_LOCATION_CODE); end;");
                oci_bind_by_name($stid, ":cur_data", $curs, -1, OCI_B_CURSOR);
                ...
                echo "<table class='display' id='locationWise' >
                        ...
                        <tbody>";
                            ...
                            // declare variable for location total 
                            $sum_energy_arr = $sum_currnet_prin = $sum_vat_arr = $sum_current_vat = $sum_surcharge_arr = $sum_current_lps = 0;

                            // declare variable for location
                            $total_location_sum_energy_arr = $total_location_sum_currnet_prin = $total_location_sum_vat_arr = $total_location_sum_current_vat = $total_location_sum_surcharge_arr = $total_location_sum_current_lps = 0;
                            ...
                            // declare variable for last location total
                            $last_location_sum_energy_arr = $last_location_sum_currnet_prin = $last_location_sum_vat_arr = $last_location_sum_current_vat = $last_location_sum_surcharge_arr = $last_location_sum_current_lps = 0;
                            ...
                            for($k=0; $k<count($output); $k++){
                                ...
                                || ($LOCATION_CODE != $output[$k]['LOCATION_CODE'])){
                                    ...
                                    // individual location total starts
                                    if($k!='0' && $LOCATION_CODE != $output[$k]['LOCATION_CODE']){
                                        echo "<tr>";
                                        ...
                                        echo "<td style='text-align: right;'>". number_format((float)$sum_energy_arr, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$sum_currnet_prin, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$sum_vat_arr, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$sum_current_vat, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$sum_surcharge_arr, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$sum_current_lps, 2, '.', ','). "</td>";
                                        echo "</tr>";
    
                                        // calculation
                                        $total_location_sum_energy_arr += $sum_energy_arr;
                                        $sum_energy_arr = 0;
    
                                        $total_location_sum_currnet_prin += $sum_currnet_prin;
                                        $sum_currnet_prin = 0;
    
                                        $total_location_sum_vat_arr += $sum_vat_arr;
                                        $sum_vat_arr = 0;
    
                                        $total_location_sum_current_vat += $sum_current_vat;
                                        $sum_current_vat = 0;
    
                                        $total_location_sum_surcharge_arr += $sum_surcharge_arr;
                                        $sum_surcharge_arr = 0;
    
                                        $total_location_sum_current_lps += $sum_current_lps;
                                        $sum_current_lps = 0;

                                        $j++;
                                    }
                                    // individual location total ends
                                    ...
                                    if($k!='0' && $CIRCLE_CODE != $output[$k]['CIRCLE_CODE']){
                                        ...
                                        echo "<td style='text-align: right;'>". number_format((float)$total_location_sum_energy_arr, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_location_sum_currnet_prin, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_location_sum_vat_arr, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_location_sum_current_vat, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_location_sum_surcharge_arr, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_location_sum_current_lps, 2, '.', ','). "</td>";
                                        echo "</tr>";
    
                                        // calculation
                                        $total_circle_sum_energy_arr += $total_location_sum_energy_arr;
                                        $total_location_sum_energy_arr = 0;
    
                                        $total_circle_sum_currnet_prin += $total_location_sum_currnet_prin;
                                        $total_location_sum_currnet_prin = 0;
    
                                        $total_circle_sum_vat_arr += $total_location_sum_vat_arr;
                                        $total_location_sum_vat_arr = 0;
    
                                        $total_circle_sum_current_vat += $total_location_sum_current_vat;
                                        $total_location_sum_current_vat = 0;
    
                                        $total_circle_sum_surcharge_arr += $total_location_sum_surcharge_arr;
                                        $total_location_sum_surcharge_arr = 0;
    
                                        $total_circle_sum_current_lps += $total_location_sum_current_lps;
                                        $total_location_sum_current_lps = 0;
                                    ...
                                    if($k!='0' && $ZONE_CODE != $output[$k]['ZONE_CODE']){
                                        ...
                                        echo "<td style='text-align: right;'>". number_format((float)$total_circle_sum_energy_arr, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_circle_sum_currnet_prin, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_circle_sum_vat_arr, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_circle_sum_current_vat, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_circle_sum_surcharge_arr, 2, '.', ','). "</td>";
                                        echo "<td style='text-align: right;'>". number_format((float)$total_circle_sum_current_lps, 2, '.', ','). "</td>";
                                        echo "</tr>";
    
                                        // calculation
                                        $total_zone_sum_energy_arr += $total_circle_sum_energy_arr;
                                        $total_circle_sum_energy_arr = 0;
    
                                        $total_zone_sum_currnet_prin += $total_circle_sum_currnet_prin;
                                        $total_circle_sum_currnet_prin = 0;
    
                                        $total_zone_sum_vat_arr += $total_circle_sum_vat_arr;
                                        $total_circle_sum_vat_arr = 0;
    
                                        $total_zone_sum_current_vat += $total_circle_sum_current_vat;
                                        $total_circle_sum_current_vat = 0;
    
                                        $total_zone_sum_surcharge_arr += $total_circle_sum_surcharge_arr;
                                        $total_circle_sum_surcharge_arr = 0;
    
                                        $total_zone_sum_current_lps += $total_circle_sum_current_lps;
                                    ...
                                    echo "<td style='text-align: left;'>" . $output[$k]['LOCATION_NAME'] . "</td>";
                                    ...
                                    // set zone_code, circle_code, location_code, sl_no.
                            ...
                            // last individual location total starts
                            $last_location_sum_energy_arr += $sum_energy_arr;
                            $last_location_sum_currnet_prin += $sum_currnet_prin;
                            $last_location_sum_vat_arr += $sum_vat_arr;
                            $last_location_sum_current_vat += $sum_current_vat;
                            $last_location_sum_surcharge_arr += $sum_surcharge_arr;
                            $last_location_sum_current_lps += $sum_current_lps;
                            ...
                            echo "<td></td>";
                            echo "<td style='text-align: left;'><b>Location Total</b></td>";
                            echo "<td style='text-align: right;'><b>" . number_format((float)$last_location_sum_energy_arr, 2, '.', ',') . "</b></td>";
                            echo "<td style='text-align: right;'><b>" . number_format((float)$last_location_sum_currnet_prin, 2, '.', ',') . "</b></td>";
                            echo "<td style='text-align: right;'><b>" . number_format((float)$last_location_sum_vat_arr, 2, '.', ',') . "</b></td>";
                            echo "<td style='text-align: right;'><b>" . number_format((float)$last_location_sum_current_vat, 2, '.', ',') . "</b></td>";
                            echo "<td style='text-align: right;'><b>" . number_format((float)$last_location_sum_surcharge_arr, 2, '.', ',') . "</b></td>";
                            echo "<td style='text-align: right;'><b>" . number_format((float)$last_location_sum_current_lps, 2, '.', ',') . "</b></td>";
                            echo "</tr>";
                            // last individual location total ends

                            // last individual circle total starts
                            $total_location_sum_energy_arr += $last_location_sum_energy_arr;
                            $total_location_sum_currnet_prin += $last_location_sum_currnet_prin;
                            $total_location_sum_vat_arr += $last_location_sum_vat_arr;
                            $total_location_sum_current_vat += $last_location_sum_current_vat;
                            $total_location_sum_surcharge_arr += $last_location_sum_surcharge_arr;
                            $total_location_sum_current_lps += $last_location_sum_current_lps;
                            ...
                            if($P_LOCATION_CODE == '%'){
                                ...
                                echo "<td></td>";
                                echo "<td style='text-align: left;'><b>Circle Total</b></td>";
                                echo "<td style='text-align: right;'><b>" . number_format((float)$total_location_sum_energy_arr, 2, '.', ',') . "</b></td>";
                                echo "<td style='text-align: right;'><b>" . number_format((float)$total_location_sum_currnet_prin, 2, '.', ',') . "</b></td>";
                                echo "<td style='text-align: right;'><b>" . number_format((float)$total_location_sum_vat_arr, 2, '.', ',') . "</b></td>";
                                echo "<td style='text-align: right;'><b>" . number_format((float)$total_location_sum_current_vat, 2, '.', ',') . "</b></td>";
                                echo "<td style='text-align: right;'><b>" . number_format((float)$total_location_sum_surcharge_arr, 2, '.', ',') . "</b></td>";
                                echo "<td style='text-align: right;'><b>" . number_format((float)$total_location_sum_current_lps, 2, '.', ',') . "</b></td>";
                                echo "</tr>";
                            }
